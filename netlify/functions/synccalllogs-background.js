  ...
  try {
    ...
    do {
      ...
      const requestBody = {
        ...
        limit: 100,
        // This line contains the fix for the Integer Overflow error
        after: nextCursor ? parseInt(nextCursor, 10) : undefined
      };
      ...
      // This line contains the fix for the Rate Limit error
      if (nextCursor) {
        await sleep(1000); 
      }
